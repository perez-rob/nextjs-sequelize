...
MyApp.getInitialProps = async ({
  ...
  const {
    token
  } = Object(_middleware_utils__WEBPACK_IMPORTED_MODULE_3__[/* getAppCookies */ "b"])(req);
  const user = token && Object(_middleware_utils__WEBPACK_IMPORTED_MODULE_3__[/* verifyToken */ "c"])(token.replace('Bearer ', ''));
  let pageProps = {
    user,
    asPath
  };
